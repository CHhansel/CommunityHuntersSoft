...
const ProductForOrderView = ({ product }) => {
  ...
  return (
    <div className="rounded-main bg-black hover:filter hover:brightness-75 overflow-hidden shadow w-[200px] h-[200px] " style={cardStyle}>
      <div className="flex flex-col justify-between h-full filter grayscale">
        ...
        <FormattedCurrency amount={product.price} />        </div>
      </div>
    </div>
  );
};
